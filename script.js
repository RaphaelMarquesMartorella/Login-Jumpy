function validateForm() {
    ...
    if (x == "") {
        nome.innerHTML  = `<input type="text"  placeholder="Nome completo" class="input" id="nome" name="nome">
            <b>*Campo obrigatório*</b>`
      return false;
    }
    if (y == "") {
        email.innerHTML = `<input type="text"  placeholder="Email@email.com" class="input" id="email" name="email">
       <b>*Campo obrigatório*</b>`
       return false;  
    }
    
    if (z == "") {
        tel.innerHTML = `<input type="text"  placeholder="(24) 991513-4965" class="input" id="tel" name="tel">
            <b>*Campo obrigatório*</b>` 
      return false;
    }
    if (a == "") {
        cpf.innerHTML = `<input type="text"  placeholder="452.849.235-980" class="input" id="cpf" name="cpf">
            <b>*Campo obrigatório*</b>` 
      return false;
    }
    if (b == "") {
        senha.innerHTML = `<input type="text"  placeholder="*******************" class="input" id="senha" name="senha">
            <b>*Campo obrigatório*</b>` 
      return false;
    }
